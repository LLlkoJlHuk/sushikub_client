			...
			<div className={styles['admin-page']}>
				<div className='container'>
					...
					<div className={styles['admin-page__content']}>
						<div
							className={styles['admin-page__content-add-product-container']}
						>
							<h2>Товары</h2>

							<div
								className={styles['admin-page__content-add-product-buttons']}
							>
								{/* Добавить товар */}
								...
								{isDevMode && (
									<div
										className={
											styles['admin-page__content-add-product-category']
										}
									>
										<Button
											onClick={openBannersModal}
								...
								{/* Настройки */}
								<div
									className={styles['admin-page__content-add-product-category']}
								>
									<Button
						...
						<div className={styles['admin-page__content-products']}>
							<table className={styles['admin-page__content-products-table']}>
								<thead
									className={styles['admin-page__content-products-header']}
								>
									{/* Шапка таблицы */}
									<tr>
										<td className={styles['image']} width='80'></td>
										<td className={styles['name']} width='150'>
											<span>Название</span>
										</td>
										<td className={styles['description']} width='300'>
											<span>Описание</span>
										</td>
										<td className={styles['price']} width='100'>
											<span>Цена</span>
										</td>
										<td className={styles['article']} width='100'>
											<span>Артикул</span>
										</td>
										<td className={styles['weight']} width='100'>
											<span>Вес</span>
										</td>
										<td className={styles['inStock']} width='100'>
											<span>В наличии</span>
										</td>
										<td className={styles['order']} width='100'>
											<span>Порядок</span>
										</td>
										<td className={styles['category']} width='120'>
											<span>Категория</span>
										</td>
										<td className={styles['type']} width='100'>
											<span>Тип</span>
										</td>
												...
												<tr key={product.id}>
													<td>
														<img
															...
															src={getImageUrl(product.img) || Plug}
															alt={product.name}
														/>
													</td>
													...
													<td className={styles['inStock']}>
														<span>{product.inStock ? 'Да' : 'Нет'}</span>
													</td>
													<td className={styles['order']}>
														<span>{product.order ? product.order : '-'}</span>
													</td>
