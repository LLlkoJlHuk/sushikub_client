...
const Sale4 = observer(() => {
	...
	const banner =
		banners.banners && banners.banners.length > 3 ? banners.banners[3] : null
		...
		<SalePageLayout>
			<div className='page-sale'>
				...
				<div className='page-sale__content'>
					...
					<p className='page-sale__content-description'>
						Появление каждого нового клиента мотивирует наших сотрудников быть
						еще лучше!? <br />
						Cообщите оператору контрольную фразу{' '}
						<span>&laquo;Роллы на&nbsp;пробу&raquo;</span> и&nbsp;то, что
						вы&nbsp;заказываете в&nbsp;первый раз. <br />
