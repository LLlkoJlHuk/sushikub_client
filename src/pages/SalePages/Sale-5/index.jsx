		...
		<SalePageLayout>
			<div className='page-sale'>
				...
				<div className='page-sale__content'>
					...
					<p className='page-sale__content-description'>
						Теперь ты&nbsp;знаешь, что делать в&nbsp;обед&nbsp;&mdash;
						конечно&nbsp;же заказывать роллы и&nbsp;суши в&nbsp;Суши Кубе?{' '}
						<br />
						Cообщите оператору контрольную фразу{' '}
						<span>&laquo;Счастливые часы&raquo;</span> <br />
						Акция действует ежедневно, кроме выходных и&nbsp;праздничных дней.{' '}
						<br />
					</p>
